...
export default function Login() {
  ...
  const handleGoogle = () => {
    // TODO: integrar @react-oauth/google
  };
      ...
      >
        <div className="card-solid p-8">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 px-4 py-3 rounded-xl border border-gray-200 dark:border-white/10 hover:bg-gray-50 dark:hover:bg-white/5 transition-colors"
          >
